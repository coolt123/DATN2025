    ...
    public partial class DB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_customer_loyalties", x => x.LoyaltyId);
                    table.ForeignKey(
                        name: "FK_customer_loyalties_AspNetUsers_IdUser",
                        column: x => x.IdUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_inventory_logs", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customer_loyalties_IdUser",
                table: "customer_loyalties",
                column: "IdUser");
