...
namespace DATN.DbContexts
{
    public class Data : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<ProductDescriptionDetail> productDescriptionDetails { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductDescriptionDetail>(e =>
            {
                e.ToTable("productdescriptiondetail");
                e.HasKey(e=>e.IdDescription);
                e.HasOne(e=>e.Product)
                    .WithMany(e=>e.DescriptionDetails)
